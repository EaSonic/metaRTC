...
constexpr char kSdpMediaProtoSctpDefault[] = "UDP/DTLS/SCTP";
...
constexpr char kSdpCodecByteVC1[] = "ByteVC1";
constexpr char kSdpCodecRtx[]  = "rtx";
constexpr char kSdpCodecAV1[]   = "AV1";
...
constexpr char kSdpCodecRrtr[] = "rrtr";
constexpr char kSdpSpropParameterSets[] = "sprop-parameter-sets";
constexpr char kSdpSpropVps[] = "sprop-vps";
constexpr char kSdpSpropSps[] = "sprop-sps";
constexpr char kSdpSpropPps[] = "sprop-pps";
constexpr char kSdpVideoResolutionWidth[] = "Width";
constexpr char kSdpVideoResolutionHeight[] = "Height";
...
constexpr char kSdpExtOrderInStream[] = "http://www.webrtc.org/experiments/rtp-hdrext/order-in-stream";
constexpr char kSdpExtRefFrameTimestamp[] = "uri:webrtc:rtc:rtp-hdrext:video:reference-frame-timestamp";
constexpr char kSdpExtSeqRange[] = "uri:webrtc:rtc:rtp-hdrext:video:frame-seq-range";
constexpr char kSdpExtVideoFrameType2[] = "uri:webrtc:rtc:rtp-hdrext:video:frame-type";
constexpr char kSdpExtAacConfig[] = "uri:webrtc:rtc:rtp-hdrext:audio:aac-config";

constexpr char kSdpDatachannelName[] = "webrtc-datachannel";
...
class SdpParser {
 ...
 private:
  ...
  bool isInSessionLevel() { return !static_cast<bool>(cur_media_ptr_); }

  bool isInMediaLevel() { return static_cast<bool>(cur_media_ptr_); }
 ...
 private:
  ...
  size_t      line_idx_ = 0;
  const char* line_data_ = nullptr;
  size_t      line_length_ = 0;
};  // class SdpParser


using SessionAttrParseHandle =
    std::function<bool(SessionDescriptionPtr, std::string&&, const char*, size_t)>;
using MediaAttrParseHandle =
    std::function<bool(MediaDescriptionPtr, std::string&&, const char*, size_t)>;
